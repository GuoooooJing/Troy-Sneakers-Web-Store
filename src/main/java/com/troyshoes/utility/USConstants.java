...
public class USConstants {
	...
	public final static List<String> listOfUSSatesCode = new ArrayList<>(mapOfUSStates.keySet());
	public final static List<String> listOfUSSatesName = new ArrayList<>(mapOfUSStates.values());
}
